  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
              Nhập họ tên bị can một lần. Các dòng căn cứ, Điều 1, Điều 3 và nơi nhận sẽ tự đồng bộ.
      ...
      <SectionCard
        ...
        description="Tên bị can ở đây là nguồn chính. Sửa tại đây, các chỗ lặp sẽ tự cập nhật."
      >
