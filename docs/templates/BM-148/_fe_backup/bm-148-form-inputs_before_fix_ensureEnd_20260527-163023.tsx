...
function syncDerivedFields(form: Bm148FormInputs): Bm148FormInputs {
  ...
  const offense = form.helper.offenseName.trim() || "Đánh bạc";
  const clause = form.helper.legalClause.trim() || "khoản 1";
  const article = form.helper.legalArticle.trim() || "Điều 321";
