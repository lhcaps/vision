  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
              Nhập dữ liệu vào ô nào thì ô đó sẽ được lưu y nguyên. Chỉ bấm "Đồng bộ dòng lặp" khi muốn hệ thống tự build lại các dòng căn cứ, Điều 1, Điều 3 và nơi nhận từ tên bị can/tội danh/ngày tháng.
      ...
      <SectionCard
        ...
        description={'Các ô trong phần này là dữ liệu nguồn. Sau khi sửa, bấm "Đồng bộ dòng lặp" nếu muốn cập nhật lại các dòng căn cứ và nội dung điều khoản. Nếu đã sửa thủ công các dòng căn cứ/điều khoản thì không bấm đồng bộ.'}
      >
