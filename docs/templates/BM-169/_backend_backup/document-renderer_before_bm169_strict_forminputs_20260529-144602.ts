...
// BM-059_AGENCY_BODY_CASE_FIX_END
    ...
    if (templateCode === "BM-169") {
      ...
      const offenseName = bm169First(
        bm169FormEvidenceHandling["offenseName"],
      ...
      const legalArticle = bm169First(
        bm169FormEvidenceHandling["legalArticle"],
      ...
      const includeAccusedDecisionLine = bm169Bool(
        bm169First(
          bm169FormEvidenceHandling["includeAccusedDecisionLine"],
          bm169EvidenceHandling["includeAccusedDecisionLine"],
        ),
        true,
      );
      ...
      const includeAccusedSuspensionDecisionLine = bm169Bool(
        bm169First(
          bm169FormEvidenceHandling["includeAccusedSuspensionDecisionLine"],
          bm169EvidenceHandling["includeAccusedSuspensionDecisionLine"],
        ),
        true,
      );
