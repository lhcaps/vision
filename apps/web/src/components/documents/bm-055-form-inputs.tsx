  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="6. Biện pháp cấm đi khỏi nơi cư trú">
        ...
        <Field required multiline className="md:col-span-2" label="Lý do hủy bỏ biện pháp" value={form.measure.cancelReasonLine} onChange={(value) => updateField("measure", "cancelReasonLine", value)} />
        <Field required multiline className="md:col-span-2" label="Nội dung Điều 1" value={form.measure.cancellationArticle1Line} onChange={(value) => updateField("measure", "cancellationArticle1Line", value)} />
        <Field required multiline className="md:col-span-2" label="Nội dung Điều 2" value={form.measure.cancellationArticle2Line} onChange={(value) => updateField("measure", "cancellationArticle2Line", value)} />
      </SectionCard>
