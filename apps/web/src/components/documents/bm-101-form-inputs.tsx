...
type Bm101FormInputsPanelProps = {
...
const EMPTY_FORM: Bm101Form = {
  ...
  decisionSupplement: {
    procedureArticlesLine:
      "Căn cứ các điều 176, 177, 178 của Bộ luật Tố tụng hình sự;",
...
function buildReasonLine(form: Bm101Form): string {
  ...
  if (!data.reasonLine.trim()) {
    return `Xét thấy việc bổ sung quyết định khởi tố bị can là cần thiết và có căn cứ.`;
  }
...
function validateForm(form: Bm101Form): string[] {
  const required = [
    ...
    ["Căn cứ tố tụng", form.decisionSupplement.procedureArticlesLine],
    ["Quyết định cũ", form.decisionSupplement.oldDecisionInfoLine],
    ["Lý do bổ sung", form.decisionSupplement.reasonLine],
    ["Tên bị can", form.decisionSupplement.personName],
    ["Tội danh", form.decisionSupplement.offenseName],
...
function buildSaveBody(form: Bm101Form) {
  ...
  const decisionSupplement = {
    procedureArticlesLine:
      form.decisionSupplement.procedureArticlesLine,
...
export function Bm101FormInputsPanel({
  ...
  const patch = <T extends keyof Bm101Form>(
    section: T,
    key: keyof Bm101Form[T],
    value: string,
  ) => {
    setForm((current) => ({
      ...current,
    ...
    <div className="space-y-5 rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
      ...
      >
        <Field
          ...
          onChange={(value) =>
            patch("decisionSupplement", "procedureArticlesLine", value)
          }
        />
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionSupplement", "oldDecisionInfoLine", value)
          }
        />
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionSupplement", "reasonLine", value)
          }
        />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Field
            ...
            onChange={(value) =>
              patch("decisionSupplement", "personName", value)
            }
          />
          ...
          <Field
            ...
            onChange={(value) =>
              patch("decisionSupplement", "offenseName", value)
            }
          />
        </div>
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionSupplement", "newDecisionLine", value)
          }
        />
      </SectionCard>
