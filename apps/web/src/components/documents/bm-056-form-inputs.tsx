...
export function Bm056FormInputsPanel({
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="3. Người bị tạm hoãn xuất cảnh">
      ...
      >
        <Field required multiline label="Lý do tạm hoãn xuất cảnh" value={readyForm.measure.exitPostponementReasonLine} onChange={(value) => updateField("measure", "exitPostponementReasonLine", value)} className="md:col-span-2" />
        ...
        <Field required label="Cơ quan quản lý xuất nhập cảnh" value={form.measure.immigrationAgencyName} onChange={(value) => updateField("measure", "immigrationAgencyName", value)} />
        <Field multiline label="Nội dung Điều 1" value={readyForm.measure.exitPostponementArticle1Line} onChange={(value) => updateField("measure", "exitPostponementArticle1Line", value)} className="md:col-span-2" />
        <Field required multiline label="Nội dung Điều 2" value={readyForm.measure.exitPostponementArticle2Line} onChange={(value) => updateField("measure", "exitPostponementArticle2Line", value)} className="md:col-span-2" />
      </SectionCard>

      <SectionCard title="5. Liên hệ, nơi nhận">
        <Field required label="Số điện thoại liên hệ" value={form.monitoring.phone} onChange={(value) => updateField("monitoring", "phone", value)} />
        <Field required label="Kiểm sát viên thụ lý" value={form.monitoring.prosecutorName} onChange={(value) => updateField("monitoring", "prosecutorName", value)} />
        <Field required label="Nơi nhận - người bị tạm hoãn" value={readyForm.recipients.personLine} onChange={(value) => updateField("recipients", "personLine", value)} />
        <Field required label="Nơi nhận - cơ quan xuất nhập cảnh" value={readyForm.recipients.immigrationUnitLine} onChange={(value) => updateField("recipients", "immigrationUnitLine", value)} />
