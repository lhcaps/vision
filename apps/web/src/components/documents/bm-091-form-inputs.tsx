...
type Bm091FormInputsPanelProps = {
...
function validateForm(form: Bm091Form): string[] {
  const required = [
    ...
    ["Căn cứ tố tụng", form.decisionAmendmentApproval.procedureArticlesLine],
    ["Quyết định cũ", form.decisionAmendmentApproval.oldDecisionInfoLine],
    ["Lý do thay đổi", form.decisionAmendmentApproval.reasonLine],
    ["Tên bị can", form.decisionAmendmentApproval.personName],
    ["Tội danh", form.decisionAmendmentApproval.offenseName],
...
function buildSaveBody(form: Bm091Form) {
  ...
  const decisionAmendmentApproval = {
    procedureArticlesLine:
      form.decisionAmendmentApproval.procedureArticlesLine,
...
export function Bm091FormInputsPanel({
  ...
  const patch = <T extends keyof Bm091Form>(
    section: T,
    key: keyof Bm091Form[T],
    value: string,
  ) => {
    setForm((current) => ({
      ...current,
  ...
  const handleFillSample = () => {
    setForm({
      ...
      decisionAmendmentApproval: {
        ...EMPTY_FORM.decisionAmendmentApproval,
      },
    ...
    <div className="space-y-5 rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
      <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-xl font-bold text-slate-950">
            QĐ phê chuẩn QĐ thay đổi QĐ khởi tố bị can
          </h2>
      ...
      >
        <Field
          ...
          onChange={(value) =>
            patch("decisionAmendmentApproval", "procedureArticlesLine", value)
          }
        />
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionAmendmentApproval", "oldDecisionInfoLine", value)
          }
        />
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionAmendmentApproval", "reasonLine", value)
          }
        />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Field
            ...
            onChange={(value) =>
              patch("decisionAmendmentApproval", "personName", value)
            }
          />
          ...
          <Field
            ...
            onChange={(value) =>
              patch("decisionAmendmentApproval", "offenseName", value)
            }
          />
        </div>
        ...
        <Field
          ...
          onChange={(value) =>
            patch("decisionAmendmentApproval", "newDecisionLine", value)
          }
        />
      </SectionCard>
