  ...
  return (
    <div className="grid gap-4">
      <section className="space-y-4">
        <div className="overflow-hidden rounded-md border border-graphite-200 bg-graphite-900/75 shadow-panel">
          ...
          <div className="grid gap-0">
            <div className="p-4">
              <div
                ref={stageRef}
                className={[
                  "annotation-canvas relative aspect-video overflow-hidden rounded-md border border-graphite-200 bg-graphite-950 sm:min-h-[360px]",
              ...
              >
                <div className="annotation-road absolute inset-[12%_7%_16%] rounded-sm border border-graphite-200" />
                <div className="absolute inset-x-[9%] top-[52%] border-t border-dashed border-graphite-200" />
                ...
                <div className="absolute bottom-3 left-3 right-3 flex flex-wrap items-center justify-between gap-2 rounded-md border border-graphite-200 bg-graphite-950/84 px-3 py-2 backdrop-blur">
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          ...
          />
          <div className="rounded-md border border-graphite-200 bg-graphite-900/75 shadow-panel">
    ...
    <div className="rounded-md border border-graphite-200 bg-graphite-900/75 shadow-panel">
      ...
      <div className="grid grid-cols-2 gap-3 p-4 md:grid-cols-4 xl:grid-cols-2">
        {metrics.map(([label, value]) => (
          <div key={label} className="rounded-md border border-graphite-200 bg-white/[0.03] p-3">
