...
describe('Coco contracts', () => {
  ...
  describe('CocoImageSchema', () => {
    ...
    it('rejects zero height', () => {
      const img = { id: 1, file_name: 'test.jpg', width: 1920, height: 0 };
      expect(() => CocoImageSchema.parse(img)).toThrow();
    });
  });
  ...
  describe('CocoCategorySchema', () => {
    ...
    it('rejects empty name', () => {
      const cat = { id: 1, name: '' };
      expect(() => CocoCategorySchema.parse(cat)).toThrow();
    });
  });
  ...
  describe('CocoAnnotationSchema', () => {
    ...
    it('rejects bbox with negative width', () => {
      const ann = {
        id: 1,
        image_id: 1,
        category_id: 1,
    ...
    it('rejects bbox with zero height', () => {
      const ann = {
        id: 1,
        image_id: 1,
        category_id: 1,
    ...
    it('rejects non-finite bbox coordinate', () => {
      const ann = {
        id: 1,
        image_id: 1,
        category_id: 1,
    ...
    it('rejects area not matching bbox width*height', () => {
      const ann = {
        id: 1,
        image_id: 1,
        category_id: 1,
        bbox: [10, 20, 100, 200],
        area: 9999, // should be 20000
        iscrowd: 0,
      };
      expect(() => CocoAnnotationSchema.parse(ann)).toThrow();
    });
