...
// Read valid PNG fixture — generated by sharp from minimal 1x1 transparent SVG
// This passes both magic byte AND sharp integrity validation
// eslint-disable-next-line @typescript-eslint/no-require-imports
const validPngBuffer: Buffer = require('fs').readFileSync(
  __dirname + '/__fixtures__/valid-png.png'
);

// Valid MP4 header bytes for magic byte validation (enough for ftyp check)
